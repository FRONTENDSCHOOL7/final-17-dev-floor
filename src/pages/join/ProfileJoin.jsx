...
export function ProfileJoin({
  ...
  const [joinBtnDisable, setjoinBtnDisable] =
    useRecoilState(joinBtnDisableState);
  ...
  const onChangeFile = async (e) => {
    ...
    try {
      ...
      setPreData({
        ...preData,
        image: "https://api.mandarin.weniv.co.kr/" + result.filename,
      });
      console.log("이미지다!!!!");
    } catch (error) {
      console.log(error);
          ...
          <form>
            ...
            <div className='profileSubmit'>
              <button
                ...
                style={{
                  backgroundColor: joinBtnDisable
                    ? "var(--bgColor)"
                    : "var(--disableColor)",
                }}
              >
